...
% fixStimulus.cueColor = fixStimulus.cueColor * fixStimulus.cueContrast;
% fixStimulus.responseColor= fixStimulus.responseColor * fixStimulus.cueContrast ;
...
%     mglTextSet(fixStimulus.digitFont,fixStimulus.digitSize,fixStimulus.digitColor,0,0,0,0,0,0,0);
%     mglTextDraw(task.thistrial.currentText,[0 0]);
%     mglStrokeText( string, x, y, scalex, scaley, linewidth, color, rotation );
%     mglStrokeText( task.thistrial.currentText, 0, 0, 0.5, 0.4, 2, [1 1 1], 0 ); 
